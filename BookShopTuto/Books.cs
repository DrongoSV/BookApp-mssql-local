...
namespace BookShopTuto
{
    public partial class Books : Form
    {
        ...
        SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\BookShopTuto\BookShopDb.mdf;Integrated Security=True;Connect Timeout=30");
